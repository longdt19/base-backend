...
from .constants import STRING_LENGTH, GENDERS
from .methods import get_constant_by_name, get_now_timestamp
...
class Base(object):
    slug = db.StringField()
    created_at = db.FloatField(default=lambda: get_now_timestamp())
...
class BaseDocument(db.Document, Base, Serializer):
    ...
    def update(self, **kwargs):
        ...
        kwargs['updated_at'] = get_now_timestamp()
...
class File(object):
    ...
    mime_type = db.StringField(max_length=STRING_LENGTH['SHORT'], required=True)
